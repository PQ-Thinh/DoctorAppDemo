package com.example.doctorappdemo.feature.topdoctors
...
import com.example.doctorappdemo.feature.topdoctors.components.DoctorsRowCard

@Composable
fun TopDoctorsScreen(
    doctors: List<DoctorModel>,
    onBack: () -> Unit,
    onOpenDetail: (item: DoctorModel) -> Unit,
